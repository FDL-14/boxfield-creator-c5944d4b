    ...
    <div className="container mx-auto py-8">
        ...
        <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <div className="py-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-4 border rounded-md p-4">
                <h3 className="font-medium">Seções e Campos</h3>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox 
              ...
              <div className="space-y-4 border rounded-md p-4">
                <h3 className="font-medium">Assinaturas e Imagens</h3>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="can_sign" 
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="can_insert_logo">Inserir Logotipos</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="can_insert_photo" 
                    ...
                    />
                    <Label htmlFor="can_insert_photo">Inserir Fotos</Label>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 border rounded-md p-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="can_save">Salvar Documentos</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="can_save_as" 
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="can_download">Baixar Documentos</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="can_open" 
                    ...
                    />
                    <Label htmlFor="can_open">Abrir Documentos</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      id="can_print" 
                    ...
                    />
                    <Label htmlFor="can_print">Imprimir Documentos</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
      ...
      <Dialog open={confirmDialogOpen} onOpenChange={setConfirmDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="py-4">
            <p>
              Tem certeza que deseja excluir <strong>{editingUser?.name}</strong>?
            </p>
            <p className="mt-2 text-muted-foreground">
